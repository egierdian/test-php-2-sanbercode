...
<body>
    ...
    <?php 
        ...
        */
        ...
        // Output: 
        for($r=0; $r<4; $r++){
            $array_items[$r] = array('id' => $items[$r][0], 'name' => $items[$r][1], 'price'=> $items[$r][2], 'description'=> $items[$r][3], 'source'=> $items[$r][4] );
